...
unsigned int lux_value_cfg ;
unsigned int low_light_value ;
# 37 "../../Lab2/AQC1.X/main.c"
...
void setReceiver(void){
    ...
    RCSTAbits.SPEN = 1;
# 101 "../../Lab2/AQC1.X/main.c"
    RCSTAbits.CREN =1;
# 113 "../../Lab2/AQC1.X/main.c"
}
...
__attribute__((picinterrupt(("")))) void interruptServiceRoutine(void){
...
void checkLeds(){
    ...
    if(!standby && !alarm){
        ...
        if(convertADC_0() > low_light_value || convertADC_1() > low_light_value )
        {
            if( lux_value < lux_value_cfg){
            ...
            else if(convertADC_0() > convertADC_1() ){
                PORTBbits.RB6 = 1;
                PORTBbits.RB7 = 0;
...
# 492 "../../Lab2/AQC1.X/main.c"
            ...
            PIR1bits.RCIF = 0;
            buffer[12] = buffer[20] = buffer[21] = 'e';
        }
        if(timer){
            count++;
            timer = 0;
